...
cycle_count = 0
_magnet_state = 0  # Estado do ímã (ligado/desligado)
_pump_state = 0  # Estado da bomba d'água (ligada/desligada)
...
def get_states():
    global _magnet_state
    global _pump_state
    return {"magnet": _magnet_state, "pump": _pump_state}
