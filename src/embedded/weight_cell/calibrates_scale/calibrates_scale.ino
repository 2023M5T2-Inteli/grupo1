...
void loop() {
  ...
  if (scale.is_ready()) { //Verifica a conexão com HX711
    ...
    delay(10000);
    long reading = scale.get_units(10); get_units //obtém a média do último número definido de leituras menos o peso da tara dividido pelo fator de calibração
    Serial.print("Result: ");
