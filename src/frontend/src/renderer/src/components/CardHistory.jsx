                    ...
                    <div style={{position: 'fixed', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', backgroundColor: 'white', padding: '20px', borderRadius: '10px', zIndex: 9999}}>
                        ...
                        <div style={{display:'flex', alignItems:'flex-start'}}>
                            ...
                            <strong><h2>Uma unica vez:</h2></strong>
                                ...
                                Nome do cliente: {props.id}<br />
                                Nome do projeto: {props.id}<br />
                                Usuario/operador: {props.id}<br />
                                Massa incial solidos: {props.massa}<br />
                            ...
                            <strong><h2>Uma vez por ciclo:</h2></strong>
                                Numero do ciclo:{props.id}<br />
                                Camp magnético utlizado: {props.id}<br />
                                Masso por ciclo (se possivel): {props.id}<br />
                                Tempo por ciclo (se possivel): {props.id}<br />
                           </div>
                       </div>
